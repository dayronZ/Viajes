    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p>Descubre los destinos más increíbles del mundo con nosotros. Tu próxima aventura está a un clic de distancia.</p>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li>Visitas los blogs</li>
            <li>Nuestras ofertas</li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <p>&copy; 2025 Viajes & Aventuras UTSH.</p>
